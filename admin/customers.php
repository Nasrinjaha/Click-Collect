                    ...
                    <div class="col-md-12 mt-0 mb-5">
                        ...
                        <td></td>
                                ...
                                <td>
                                    ...
                                    <a class = "btn btn-danger" data-toggle="modal" data-target="#myModal<?php  echo $row['c_id'];?>">Block</a>
                                    <!-- Modal -->
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            <a class = "btn btn-success" href ="block_customer.php?id=<?php  echo $row['c_id']?>">yes</a>
