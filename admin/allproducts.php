                    ...
                    <div class=" mt-0 mb-5">
                        ...
                        <td></td>
                                ...
                                <td>
                                    ...
                                    <td>
                                    <a class = "btn btn-danger" data-toggle="modal" data-target="#myModal<?php  echo $row['p_id'];?>">Block</a>
                                    <!-- Modal -->
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            <a class = "btn btn-success" href ="block_product.php?id=<?php  echo $row['p_id']?>">yes</a>
