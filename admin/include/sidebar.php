...
<h2>My Account</h2>
   <ul>
        ...
        <li><a href="block_customers_list.php">Block Customers</a></li>
        <li><a href="block_sellers_list.php">Block Sellers</a></li>
        <li><a href="block_products_list.php">Block Products</a></li>
