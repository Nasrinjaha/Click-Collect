        ...
        <div class="row">
            <div class="col-md-4">
                <div class="footer-top-address wow slideInLeft" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">
                    ...
                    <ul>
                        <li><i class="fa fa-map-marker"></i> Premier University,chittagong</li>
                        <li><i class="fa fa-mobile"></i> 01835493825 </li>
                        <li><i class="fa fa-phone"></i> +222 11 4444 </li>
                        <li><i class="fa fa-envelope-o"></i> <a href="mailto:ripanasrin62@gmail.com"> ripanasrin62@gmail.com</a></li>
                    </ul> 
                </div>
...
<div class="footer-bottom">
    <p class="footer-credit">
        &copy;<script type="text/javascript">document.write(new Date().getFullYear())</script> - All rights reserved <a href="index.html">Your shop</a> | Designed by  Nasrin Jahan Ripa 
    </p>
