...
<div class="container mt-3">
  <div class="mt-4 p-4 bg-secondary text-light rounded">
    ...
    <p class="para">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum doloremque facere modi quae minima, nemo obcaecati eligendi aut et beatae quaerat, perspiciatis, error repudiandae veniam possimus accusantium similique dicta non!</p> 
  </div>
  <div class="mt-5 card">
