            ...
            <div class="card bg-light text-dark">
                <div class="row">
                    ...
                    <div class="col-md-8 mt-5 mb-5">
                        ...
                        <br>
                        <form method="post" class="cmxform" action="test.php" enctype="multipart/form-data" id="signUpForm">
                        ...
                        <?php
                            if(isset($_POST['submit'])){
                                ...
                                $query2 = "INSERT INTO request_products(name,b_id,sub_id,size,description,price,quantity)
                                ...
                                $i=1;
                                $pid=0;
                                $query = "SELECT *  FROM request_Products where 1";
                                ...
                                foreach($_FILES['files']['tmp_name'] as $key => $value){
                                    ...
                                    $image = $image.".".$ext;
                                    $i++;
                                    $query1 = "INSERT INTO request_products_images(rp_id,image)
                                    VALUES('$pid','$image')";
